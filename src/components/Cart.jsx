...
const Cart = () => {
    ...
    const handleOrder = async () => {
        try {
            ...
            const response = await axios.post('http://localhost:3001/order/place', orderData);
    ...
    return (
        <div>
            ...
            <br />
            <br />
            <Button variant='contained' color='success' onClick={handleOrder}>Place Order</Button>
        </div>
    );
};
